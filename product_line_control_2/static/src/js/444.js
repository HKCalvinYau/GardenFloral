odoo.define('product_line_control_2.products_searchbar_garden', function (require) {
'use strict';
...
publicWidget.registry.productsSearchBar = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/product_line_control_2/static/src/xml/search.xml'],
    events: {
    ...
    _render: function (res) {
        ...
        if (res) {
            ...
            this.$menu = $(qweb.render('product_line_control_2.productsSearchBar.autocomplete', {
                products: products,
